...
#include "../../../conf/CompilerConfig.hpp"
#include "../../../conf/CompilerWarningsSupport.hpp"
...
int main(int argc,
         char ** args)
{
    IGNORE_UNUSED_VARIABLE(argc);
    
    terminal_arguments__client_site full_terminal_argumensts;
    {
        MainSupportTerminal<terminal_arguments__client_site> a;
